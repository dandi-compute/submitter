...
*/1 * * * * /bin/bash -l -c 'flock -n /orcd/data/dandi/001/dandi-compute/submitter/submitter.lock -c "/orcd/data/dandi/001/dandi-compute/runner/guarded-submit -- sbatch --output /dev/null --error=/dev/null /orcd/data/dandi/001/dandi-compute/submitter/launch_runner.sh" || echo "$(date): lock held, skipping submit"' > /dev/null 2>&1
```
