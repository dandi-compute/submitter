...
*/1 * * * * /bin/bash -l -c 'flock -n /orcd/data/dandi/001/dandi-compute/flocks/submitter.lock -c "/orcd/data/dandi/001/dandi-compute/submitter/guarded-submit -- sbatch --output /dev/null --error=/dev/null /orcd/data/dandi/001/dandi-compute/submitter/launch_runner.sh" || echo "$(date): lock held, skipping submit"' > /dev/null 2>&1
*/1 * * * * /bin/bash -l -c 'flock -n /orcd/data/dandi/001/dandi-compute/flocks/monitor.lock -c "/orcd/data/dandi/001/dandi-compute/submitter/guarded-submit -- sbatch --output /dev/null --error=/dev/null /orcd/data/dandi/001/dandi-compute/submitter/launch_monitor.sh" || echo "$(date): lock held, skipping submit"' > /dev/null 2>&1
```
